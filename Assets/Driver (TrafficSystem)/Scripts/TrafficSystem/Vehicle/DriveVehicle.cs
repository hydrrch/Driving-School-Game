...
public class DriveVehicle : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            Transform _lerpRef = FindChild(other.transform.root);
            if (_lerpRef != null)
            {
                PlayerCamera.lerpRef = _lerpRef;
            }
        }
    }

    Transform FindChild(Transform transform)
    {
        Transform parent = transform.transform;
        Transform child = parent.Find("player cam lerp ref");
    ...
    public void GetinCar()
    {
        ...
        switch (playerCarStatus)
        {
            ...
            case PlayerCarStatus.Sit:
                ...
                GameObject _currentCar = AIContoller.manager.vehicleCamera.target.gameObject;
                _currentCar.GetComponent<CarMusicController>().PlayMusic();
            ...
            case PlayerCarStatus.OutCar:
                ...
                GameObject _currentCar1 = AIContoller.manager.vehicleCamera.target.gameObject;
                _currentCar1.GetComponent<CarMusicController>().StopMusic();
