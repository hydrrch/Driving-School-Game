...
public class RCC_MobileButtons : MonoBehaviour
{
    ...
    public Transform tiltBrakePos;
    public Transform originalBrakePos;
    ...
    [SerializeField] bool SetButtons;
    void Update()
    {
        ...
        if (RCCSettings.useSteeringWheelForSteering)
        {
            ...
            if (SetButtons)
                brakeButton.transform.position = originalBrakePos.position;
        }
        ...
        if (RCCSettings.useAccelerometerForSteering)
        {
            ...
            if (SetButtons)
                brakeButton.transform.position = tiltBrakePos.position;
        }
