...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class ScreenSpaceAmbientOcclusion : MonoBehaviour
    {
        ...
        [SerializeField] ScreenSpaceAmbientOcclusion ambienceEffect;
        [SerializeField] int processorFreq;

        private void Awake()
        {
            if (SystemInfo.processorFrequency < processorFreq)
                ambienceEffect.enabled = false;
            else
                ambienceEffect.enabled = true;
        }
        void Start()
        {
